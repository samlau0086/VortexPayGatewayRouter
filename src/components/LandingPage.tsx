...
const translations = {
  zh: {
    ...
    mo: '/ 月',
    once: '/ 一次性',
    freeFeatures: ['免费试用时长全功能2天', '限制最高 1 个 A 站接入', '限制最高 1 个 B 站网关', '标准接入文档支持'],
  ...
  en: {
    ...
    mo: '/ mo',
    once: '/ once',
    freeFeatures: ['2-Day Full Feature Trial', 'Limited to 1 Business Site', 'Limited to 1 Payment Gateway', 'Standard Documentation Support'],
